    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('theme', models.CharField(choices=[('men', 'Dark Neon'), ('women', 'Pastel Neon')], default='men', max_length=10)),
